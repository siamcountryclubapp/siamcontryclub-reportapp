...
function renderGeneral() {
    ...
    else if (count === 2) { reportContent.style.gridTemplateColumns = '1fr 1fr'; reportContent.style.gridTemplateRows = '1fr'; } 
    else if (count === 3) { reportContent.style.gridTemplateColumns = '1fr 1fr'; reportContent.style.gridTemplateRows = '1fr 1fr'; } 
    else if (count === 4) { reportContent.style.gridTemplateColumns = '1fr 1fr'; reportContent.style.gridTemplateRows = '1fr 1fr'; } 
